        ...
        <div className="">
            <div className="p-6 border-b border-primary-100">
                <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-primary-700">Message Management</h1>
                        <p className="text-gray-600 text-sm mt-1">View and manage messages from the Get In Touch form</p>
                    </div>
