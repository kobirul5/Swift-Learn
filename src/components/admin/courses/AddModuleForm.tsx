...
export default function AddModuleForm({ courseId, onSuccess }: Props) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-8 mb-10">
      <h3 className="text-2xl font-bold text-dark-900 mb-6">Add New Module</h3>
      <div className="flex flex-col sm:flex-row gap-4">
        <input
          ...
          className="flex-1 px-5 py-3 border border-dark-200 rounded-xl focus:ring-4 focus:ring-primary-100 focus:border-primary-500 text-lg bg-white"
        />
        <button
