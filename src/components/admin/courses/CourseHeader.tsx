...
export default function CourseHeader({
  ...
  updatedAt,
    ...
    console.log({title, description, thumbnail, price, modulesCount, isFeatured, updatedAt}, "course header props---");
  return (
      ...
      <div className="flex gap-2 justify-center items-center">
        ...
        <div className="md:col-span-2 p-8 lg:p-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              <p className="text-sm text-gray-500 uppercase tracking-wider">Modules</p>
              <p className="text-3xl font-bold text-gray-900 mt-2">{modulesCount}</p>
            </div>
            <div>
            ...
            <div>
              <p className="text-sm text-gray-500 uppercase tracking-wider">Updated</p>
